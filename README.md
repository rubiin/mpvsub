...
[![CI](https://github.com/rubiin/mpvsub/actions/workflows/ci.yml/badge.svg)](https://github.com/rubiin/mpvsub/actions/workflows/ci.yml)
...
GPL-3.0 — see `LICENSE`. The OpenSubtitles client is a port of the
official VLSub extension, which is also GPL-3.0.
